    ...
    >
      <div className="space-y-20 pt-10">
        ...
        <div className="text-center max-w-[1400px] mx-auto">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-8 gap-3 md:gap-4 px-4 md:px-6">
            {countries.map((c) => (
              <button
                key={c.id}
                onClick={() => {
                ...
                className={`p-3 md:p-4 rounded-2xl md:rounded-3xl font-black text-[10px] md:text-xs transition-all border flex flex-col items-center justify-center gap-2 md:gap-3 ${
              ...
              >
                ...
                />
                <span className="text-center truncate w-full px-1">{c.name}</span>
              </button>
            ))}
          </div>
        </div>
