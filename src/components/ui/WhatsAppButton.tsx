    ...
    <div className="fixed bottom-10 left-10 z-[100] hidden md:block">
      <MagneticButton strength={0.4}>
        <motion.a
          ...
          className="w-14 h-14 rounded-full bg-[#25D366] text-white flex items-center justify-center shadow-[0_15px_40px_rgba(37,211,102,0.5)] relative group overflow-hidden"
        ...
        >
          ...
          <div className="absolute top-0 right-0 w-2.5 h-2.5 bg-white rounded-full m-2 animate-pulse shadow-sm z-20" />
        </motion.a>
      </MagneticButton>
    </div>
  );
