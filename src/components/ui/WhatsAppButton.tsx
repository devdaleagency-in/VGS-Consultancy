    ...
    <div className="fixed bottom-10 right-10 z-[100] hidden md:block">
      <MagneticButton strength={0.4}>
        <motion.a
          ...
          className="w-20 h-20 rounded-[2rem] bg-[#25D366] text-white flex items-center justify-center shadow-[0_20px_60px_rgba(37,211,102,0.4)] relative group overflow-hidden"
        ...
        >
          ...
          <div className="absolute top-0 right-0 w-4 h-4 bg-white rounded-full m-3 animate-pulse shadow-sm z-20" />
        </motion.a>
      </MagneticButton>
    </div>
  );
