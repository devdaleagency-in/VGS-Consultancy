...
export default function VisaContactForm({ visaType: initialVisaType }: { visaType: string }) {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto p-3 md:p-12 bg-white rounded-[1.5rem] md:rounded-[3rem] shadow-[0_30px_70px_rgba(37,99,235,0.08)] border border-black/5">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
          ...
          <div className="space-y-1 md:space-y-2">
            ...
            <select 
              {...register("country")}
              className="w-full px-4 md:px-6 py-3 md:py-4 bg-gray-50 border-none rounded-xl md:rounded-2xl focus:ring-2 focus:ring-primary/20 transition-all font-bold text-dark outline-none text-sm appearance-none"
            >
        ...
        <div className="space-y-1 md:space-y-2">
          ...
          <textarea 
            ...
            rows={3}
            className="w-full px-4 md:px-6 py-3 md:py-4 bg-gray-50 border-none rounded-xl md:rounded-2xl focus:ring-2 focus:ring-primary/20 transition-all font-bold text-dark outline-none resize-none text-sm"
          />
