      ...
      <AnimatePresence>
        {mobileOpen && (
          <motion.div
            ...
            className="absolute top-24 left-6 right-6 nav-liquid-glass p-10 shadow-3xl lg:hidden z-[60]"
          >
            <div className="flex flex-col gap-8 items-center">
              {navLinks.map((link) => {
                ...
                return (
                  <Link
                    ...
                    className={`text-2xl font-black transition-all ${isActive ? 'text-primary scale-110' : 'text-dark/40 hover:text-dark'
                      }`}
                  >
                    {link.name}
                  </Link>
              ...
              <a
                ...
                className="w-full flex items-center justify-center gap-3 py-5 bg-primary text-white rounded-2xl font-black text-lg shadow-xl shadow-primary/20 hover:scale-[1.02] transition-all"
              >
