          ...
          >
            <div className="flex flex-col gap-6 items-center">
              {navLinks.map((link) => {
                ...
                return (
                  <Link
                    ...
                    className={`text-xl font-black transition-all ${isActive ? 'text-primary scale-110' : 'text-dark/40 hover:text-dark'
                      }`}
                  >
                    {link.name}
                  </Link>
              ...
              <a
                ...
                className="w-full flex items-center justify-center gap-3 py-4 bg-primary text-white rounded-xl font-black text-base shadow-xl shadow-primary/20 hover:scale-[1.02] transition-all"
              >
